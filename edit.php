        ...
        <div class="row">
          <div class="col-md-4 text-center">
              <form method="POST" action="update.php" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="id" class="form-control" value="<?= $alunoAtual->id; ?>">
                  
                  <div class="form-group">
                      <label>Nome</label>
                      <input name="nome" class="form-control" value="<?= $alunoAtual->nome; ?>">
                  </div>
                  <div class="form-group">
                      <label>Média</label>
                      <input name="media" class="form-control" value="<?= $alunoAtual->media; ?>">
                  </div>
                  <div class="form-group">
                      <label>Faltas</label>
                      <input name="faltas" class="form-control" value="<?= $alunoAtual->faltas; ?>">
                  </div>
